	...
	$.get('/todo', data => {
		...
		if (todo.count == 0) {
			...
			for (let i = 0; i < todo.length; i++) {
				todobody += ` <a href="#" class="list-group-item d-flex justify-content-between dark-grey-text ">${todo[
					i
				].todo}
      <i class="fas fa-trash ml-auto todo" data-toggle="tooltip" data-placement="top" title="Click to delete" id="todo${todo[
				i
			].id}"></i></a>`;
			}
		}
