    ...
    <div class="tab-content card pt-5" id="myTabContentJust">
        <div class="tab-pane fade show active" id="seafreight-just" role="tabpanel" aria-labelledby="seafreight-tab-just">
            ...
            <div class="text-center border border-light p-5">
                ...
                <!-- Shipping Length -->
                <input type="number" id="shippinglength" class="form-control mb-4" placeholder="Shipping Length">
                <!-- Width -->
                <input type="number" id="shippingwidth" class="form-control mb-4" placeholder="Shipping Width">
                <!-- Weight -->
                <input type="number" id="shippingheight" class="form-control mb-4" placeholder="Shipping Height ">
