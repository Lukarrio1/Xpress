    ...
    >
      ...
      <div class="text-center border border-light p-5">
        ...
        <input
          ...
          id="shippingweight10"
          class="form-control mb-4"
          placeholder="Add 10 lbs rate"
        />

        <label class="">Rate For 11 lbs to 20 lbs</label>
        <input
          type="number"
          id="shippingweight10up"
          class="form-control mb-4"
          placeholder="Add 11 to 20 lbs rate"
        />
        <!-- Weight 21 to 151lbs-->
        <label class="">Rate For 21lbs to 151 lbs</label>
        <input
          type="number"
          id="shippingweight21up"
          class="form-control mb-4"
          placeholder="Add 21 to 151 lbs rate"
        />
