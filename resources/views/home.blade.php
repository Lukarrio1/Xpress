...
<div class="pt-4">
    ...
    <!-- Todo Modal -->
    <div class="modal " id="todomodalview" tabindex="-1" role="dialog" aria-labelledby="todomodalview" aria-hidden="true">
    ...
    <button type="button" class="btn btn-danger waves-effect waves-light " data-toggle="modal" data-target="#centralModalLGInfoDemo" id="tutmodal" style="display:none;">
    </button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Overseas Address</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Pre Alert</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-md-6 mb-4">
                ...
                <div class="card classic-admin-card bg-danger darken-2">
                    ...
                    <div class="progress">
                        <div class="progress-bar bg-white" role="progressbar" style="width: 0%" aria-valuemin="0" aria-valuemax="100" id="shipmentbar"></div>
                    </div>
                    <div class="card-body">
    ...
    <section class="mb-3">
        ...
        <div class="row">
            ...
            <!-- Modal -->
            <div class="modal " id="newsmodal" tabindex="-1" role="dialog" aria-labelledby="newsmodal" aria-hidden="true">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                ...
                <div class="card">
                    <div class="card-header white-text bg-danger">
                        Tasks
                        <i href="#" class="fas fa-plus fa-pull-right align-right text-white" data-toggle="modal" data-target="#taskmodal" id="taskmodal" data-placement=top title="Add new task"></i>
                    </div>
                    <!--/.Card-->
                    <div class="card-body pt-0 px-1">
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0 px-1">
                        ...
                        <div class="card-body text-center">
                            ...
                            <!-- Todo Modal -->
                            <div class="modal " id="activitymodal" tabindex="-1" role="dialog" aria-labelledby="activitymodal" aria-hidden="true">
                                <div class="modal-dialog modal-lg " role="document">
                                    <div class="modal-content">
                                        <div class="modal-header bg-danger text-white text-center">
