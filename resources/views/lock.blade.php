...
<!-- Mirrored from argon-dashboard-pro-laravel.creative-tim.com/lock by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Mar 2019 08:08:44 GMT -->
...
<link type="text/css" href="{{asset('css/argone209.css')}}" rel="stylesheet">
            ...
            <div class="header-body text-center mb-7">
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                        <h1 class="text-white">Lockscreen</h1>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <img src="argon/img/theme/team-4.jpg" class="rounded-circle border-secondary">
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"e436701188","applicationID":"243106736","transactionName":"YlNTZBMEWkMDVRAPDFsZcFMVDFteTUYFAQYbWl5TCg==","queueTime":5,"applicationTime":57,"atts":"ThRQElseSU0=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
