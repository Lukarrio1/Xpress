...
<link type="text/css" href="{{asset('css/app.css')}}" rel="stylesheet">
                ...
                <div class="card bg-secondary shadow border-0">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-center text-muted mb-4">
                            ...
                            <small>You can use <strong><a href="cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="d0b1b4bdb9be90b1a2b7bfbefeb3bfbd">[email&#160;protected]</a></strong> and <strong>secret</strong> to loggin</small>
                        </div>
                        <form role="form" method="POST" action="http://argon-dashboard-pro-laravel.creative-tim.com/login">
    ...
    <div class="col-xl-6">
        ...
        <script data-cfasync="false" src="cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="argon/vendor/jquery/dist/jquery.min.js"></script>
    ...
    <script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"e436701188","applicationID":"243106736","transactionName":"YlNTZBMEWkMDVRAPDFsZcFMVDFteTVoLAQpb","queueTime":20,"applicationTime":101,"atts":"ThRQElseSU0=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>

<!-- Mirrored from argon-dashboard-pro-laravel.creative-tim.com/login by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Mar 2019 08:07:37 GMT -->
</html>